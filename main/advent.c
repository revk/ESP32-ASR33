      ...
      for (int hint = 0; hint < NHINTS; hint++)
      {
         ...
         if (game.hintlc[hint] >= hints[hint].turns)
         {
            ...
            case 6:            /* urn */
               ...
               return;
            case 7:            /* woods */
               if (game.atloc[game.loc] == NO_OBJECT && game.atloc[game.oldloc] == NO_OBJECT
...
bool
preprocess_command (command_t * command)
   ...
   } else
   {
      if (command->word[0].type == OBJECT)
      {
         ...
         if (command->word[0].id == GRATE)
         {
            ...
            if (game.loc == LOC_COBBLE || game.loc == LOC_DEBRIS || game.loc == LOC_AWKWARD || game.loc == LOC_BIRD
                || game.loc == LOC_PITTOP)
            {
